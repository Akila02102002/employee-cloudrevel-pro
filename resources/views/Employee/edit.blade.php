            ...
            <form class="form form-add-data" action ="{{ url('admin/employees/update/'.$query->id).'?page='.$page }}" id="kt_form_1"  method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="employee_id" id="employee_id" value="{{ old('employee_id',$query->employee_id) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name',$query->name) }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" name="email" id="email" value="{{ old('email',$query->email) }}">
                        <small class="text-danger" id="email_err"></small>
                    </div>
                    <div class="col-md-3">
                        <label for="dob" class="form-label">Date of Birth <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" name="dob" id="dob" value="{{ old('dob',$query->dob) }}">
                        <small class="text-danger" id="dob_err"></small>
                    </div>
                    <div class="col-md-3">
                        <label for="doj" class="form-label">Date of Joining <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" name="doj" id="doj" value="{{ old('doj',$query->doj) }}">
